 ...
 */
Map::Map(AssetManager& assman) {
  // Request textures
  m_floorTexture = assman.requestTexture(Assets::GRASS_FLOOR);
  m_obstacleTexture = assman.requestTexture(Assets::GRASS_OBSTACLE);
  m_wallTexture  = assman.requestTexture(Assets::GRASS_WALL);
